...
from app.resouces.expenses import ExpenseResource  # type: ignore
from app.resouces.product import ProductResource  # type: ignore
from app.resouces.revenue import RevenueResource  # type: ignore
